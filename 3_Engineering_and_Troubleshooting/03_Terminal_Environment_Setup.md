...
## Objective
To standardize the shell environment across the entire homelab (matrix, skynet, Nuc), ensuring identical aliases, prompt behaviors (Tuco/Root distinction), and modern productivity features while maintaining high performance.
...
# Optimized for Matrix, Skynet, Nuc and Root accounts
